...
export default function HowToCreateDepartment(props: LayoutCardOptProps) {
  ...
  >
    <Subtitle>
      1. Define your department and its purpose.
    </Subtitle>
    <List>
      <List.Item>1. <Highlight>Name</Highlight> of the department - e.g. Education.</List.Item>
    ...
    <Subtitle>
      2. Add your department to <Anchor target="_blank" href="https://github.com/cromatikap/coin-society/blob/1b5e3b0c82299d3ff7651e5332d62943661abed7/website/src/data/Departments.ts#L18-L40">
        this file
      </Anchor>.
    </Subtitle>
  </Card>
